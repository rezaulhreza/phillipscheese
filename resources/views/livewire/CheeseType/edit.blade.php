<x-app-layout>
<div class="mt-5">
    <form method="post" action="{{ route('cheesetype.update', $cheesetype->id) }}">
        @csrf
        @method('PATCH')
    <div class="form w-1/3 mx-8">
            ...
            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                <div class="mb-3 space-y-2 w-full text-lg">
                    ...
                    <input
                    value="{{ $cheesetype->type }}"
                     wire:model="type" placeholder="Type Name" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"  type="text" name="type" id="type">
