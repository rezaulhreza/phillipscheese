            ...
            <div class="md:flex flex-row justify-items space-between md:space-x-4 w-full text-xs">
                <div class="row text-lg">
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <select id="cheese_type_id" name="cheese_type_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" @change="changeCategory">
                          ...
                          <option value="{{ $cheesetype->id }}" {{ $cheesetype->id == $supplierOrder->cheese_type_id ? 'selected' : '' }}>{{ $cheesetype->type }}</option>
                          @endforeach
                        </select>
                ...
                <div class="md:flex flex-row justify-items space-between md:space-x-4 w-full text-xs">
                    <div class="mb-3 space-y-2 w-full text-lg">
                        ...
                        <input value="{{ $supplierOrder->name }}" wire:model="name" placeholder="Supplier Name" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"  type="text" name="name" id="name">
                    ...
                    <div class="mb-3 space-y-2 w-full text-lg">
                        ...
                        <input value="{{ $supplierOrder->amount }}" wire:model="amount" placeholder="Order Amount" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"  type="number" name="amount" id="amount">
                    ...
                    <div class="mb-3 space-y-2 w-full text-lg">
                        ...
                        <input value="{{ $supplierOrder->delivery_date }}" wire:model="delivery_date" placeholder="Delivery Date" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"  type="date" name="delivery_date" id="delivery_date">
